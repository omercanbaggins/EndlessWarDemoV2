...
public:	
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite)
	TSubclassOf<class AOverlappingObjects> spawnEnemyClass;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite)
	TArray<TSubclassOf<AOverlappingObjects>> enemyGroup;
	UPROPERTY(EditDefaultsOnly)
	class USceneComponent* boundryLeft;
	UPROPERTY(EditDefaultsOnly)
	class USceneComponent* boundryRight;
